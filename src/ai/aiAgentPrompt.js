...
export function getAiAgentSystemPrompt() {
  return [
    ...
    "For drum patterns, use set_step with different stepIndex values for each hit. A 16-step pattern has indices 0-15. Common placements: kick on 0, 4, 8, 12; snare on 4, 12; hats on every even step (0, 2, 4, 6, 8, 10, 12, 14).",
