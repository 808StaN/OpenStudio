...
export function getAiAgentSystemPrompt() {
  return [
    ...
    "OpenStudio timing: 1 Channel Rack block = 1 step. 1 sequencer step = 1/8 bar. 8 steps = 1 bar, 16 steps = 2 bars, 32 steps = 4 bars, 64 steps = 8 bars, 128 steps = 16 bars.",
    "Use set_pattern_length before creating patterns longer than the current pattern. For 4 bars use 32 steps, for 8 bars use 64 steps.",
    "For drum patterns, use set_step with different stepIndex values for each hit. For a 1-bar pattern use indices 0-7: kick often 0, 4; snare/clap 2, 6; hats 0,1,2,3,4,5,6,7 or 0,2,4,6. For 2 bars continue 8-15.",
